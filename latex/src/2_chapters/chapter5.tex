...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.7\textwidth]{5_figures/chapter5/prediction_vs_inference.png}
    \caption{Representation of Anscombe's quartet. All four datasets have exact same summary statistics, while having clear different dependencies.}
    \label{fig:anscombe}
\end{figure}
