...
\end{equation}
where \(s_{\text{between}}^2\) and \(s_{\text{within}}^2\) represent the variation between samples, and within samples, and are computed as
\[
    s_{\text{between}}^2
    =
...
\begin{figure}[ht]
    ...
    % ----------- Global caption -----------
    \caption{Representation of the one-sided and two-sided \(p\)-value as the cumulative probability—the integral of the tails, the area under the curve —of the Student's \(t\)-distribution.}
...
\begin{figure}[ht]
    ...
    % ----------- Global caption -----------
    \caption{Representation of the one-sided and two-sided \(p\)-value as the cumulative probability—the integral of the tails, the area under the curve —of the Fisher's \(F\)-distribution.}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}{0.8\textwidth}
        ...
        \caption{Computation of the two-sided \(p\)-value, as the integral of both tails of the \(\chi^2\)-distribution. Given the asymmetry of the \(\chi^2\)-distribution, this is not double the size of the one-sided \(p\)-value, and as we said nonstandard and rarely meaningful in practic.}
        \label{fig:chi2_p_2_sided}
    \end{subfigure}

    % ----------- Global caption -----------
    \caption{Representation of the one-sided and two-sided \(p\)-value as the cumulative probability—the integral of the tails, the area under the curve —of the Pearson's \(\chi^2\)-distribution.}
